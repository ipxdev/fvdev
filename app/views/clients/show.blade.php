...
<br>
		{{ DropdownButton::normal(trans('texts.edit_client'),
			...
			{{ DropdownButton::primary('Emitir Factura', Navigation::links($actionLinks), ['id'=>'primaryDropDown'])->split(); }}
	    {{ Former::close() }}		
	...
	<div class="row">
		...
		<div class="col-md-8">
			<table class="table" style="width:100%">
				<tr>
					<td><h3>{{ $client->getTitular() }}</h3></td>				
				</tr>
			</table>
			<h5>&nbsp;&nbsp;<strong>Razón Social</strong> : {{ $client->getDisplayName() }}
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<strong>NIT/CI</strong> : {{ $client->getNit() }}</h5>
