...
class ActivityController extends \BaseController {
	...
	public function getDatatable($clientPublicId)
    {
        $query = DB::table('activities')
                    ...
                    ->select('activities.id', 'activities.message', 'activities.created_at', 'activities.balance', 'activities.adjustment');
        ...
        return Datatable::query($query)
            ...
            ->addColumn('adjustment', function($model) { return $model->adjustment != 0 ? Utils::formatMoney($model->adjustment, 1) : ''; })
    	    ->make();
    }	
